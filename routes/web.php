...
use App\Http\Controllers\RekamLukaBakarController;
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/rekam', [RekamLukaBakarController::class, 'index'])->name('rekam');
    Route::get('/rekam/add', [RekamLukaBakarController::class, 'add'])->name('rekam.add');
    Route::get('/rekam/{id}/edit', [RekamController::class, 'edit'])->name('rekam.edit');

    Route::post('/rekam/pasie/store', [RekamLukaBakarController::class, 'store'])->name('rekam.store');
